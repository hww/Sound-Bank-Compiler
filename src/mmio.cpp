...
char *ERROR_LOADING_SAMPLEINFO="Error loading sample info";
...
{
    _mm_write_M_UWORD((UWORD)(data>>16),fp);
    _mm_write_M_UWORD((UWORD)(data&0xffff),fp);
}

void _mm_write_I_ULONG(ULONG data,FILE *fp)
{
    _mm_write_I_UWORD((UWORD)(data&0xffff),fp);
    _mm_write_I_UWORD((UWORD)(data>>16),fp);
}
